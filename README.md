# BFS9000
Custom split ergonomic keyboard PCB based on Sofle Pico (RP2040/Pico). Reversible PCBs (same board for L/R) to cut manufacturing cost and simplify assembly. Adds breakaway function row + side packs, SK6803MINI-E per-key RGB, rear underglow, auto side ID, optional Cirque touchpad, and USBLC6-2SC6 ESD.
=======
